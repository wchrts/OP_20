...
Open the `OP_20` template repository in your IDE or text editor and navigate to `maxSupply, decimals, name, symbol.`. Look for the following section in the `onInstantiated` method:
